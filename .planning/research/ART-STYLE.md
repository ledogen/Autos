...
| `ranger.glb` | 2440 | 9 | **0** | The HERO vehicle. Clear glass, a real cockpit, an open bed, and no wheels (the game owns those). Everything the player stares at for twenty hours |
...
| **The hero vehicle** (one asset) | **4000** | `ranger.glb` (2440) — budgeted by hours looked at, not by repeats |
