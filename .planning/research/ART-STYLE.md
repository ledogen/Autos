...
| `gas-pump.glb` | 460 | 6 | **1** | The third, and the first to ATLAS: one 512×512 holds the word GAS *and* a pump gauge face, so two lettered surfaces cost one image and one draw call. Livery and rust were dropped as wear |
