...
**Plans**: 12 plans executed + 3 gap-closure SPLINE-FIX plans (09-13..15 — continuous-centerline follow + rate-limited camber + truthful viz + visible dirt shoulders; waves 1-3 sequential on shared road.js/road-mesh.js)
  ...
  - [ ] 09-13-PLAN.md — SPLINE-FIX 1/3: follow the CONTINUOUS routed centerline Y (kill per-tile _smoothDesignGrade in ribbon + physics + terrain carve) — removes seam steps AND the ~1s load lag; truthful cyan viz draws the spline geometry not analyticHeight (SURF-03/04/05, D-06/D-16)
...
| 9. Road Surface | v1.1 | 12/12 | Re-arch executed — browser verify pending | — |
