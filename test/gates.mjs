...
export const GATES = [
  ...
  { file: 'damage-impacts.mjs', subsystem: 'physics', cost: 'fast', extraDeps: ['src/damage.js'],
    desc: 'SM-3 impact calibration (owner 2026-08-19), quoted in mph but MEASURED as contact impulse (v_eq = J/mass, so a glancing blow prices as the small hit it is): unprotected engine 1%/20%, radiator 5%/50%, headlight 10%/100% and armor 10%/100% at 10/60 mph; armor absorbs 90% at full health and 10% at 10% health, so the same 30 mph tap is 10x worse into a crushed bumper; side hits stay on their side and reach no headlight; alignment is dead below 30 mph and saturates at 80 (+-2 deg camber, +-0.5 deg toe) with a SEEDED bend so a run replays identically; 60 mph is the fatal threshold and armor does not save you from it' },
