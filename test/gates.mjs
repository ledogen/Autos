...
export const GATES = [
  ...
  { file: 'penetration-failsafe.mjs', subsystem: 'physics', cost: 'fast', extraDeps: [],
    desc: 'BUG-24: catastrophic-penetration failsafe fires only on true tunnels (depth>wheelRadius), not resolvable deep contact — no body teleport on the shoulder step' },
  { file: 'body-contact-energy.mjs', subsystem: 'physics', cost: 'fast', extraDeps: [],
    desc: 'BUG-27: hard body slams strictly dissipative (restitution≈0, accumulated-impulse solver, tamed Baumgarte) — no phantom spin/launch, rest stable' },
