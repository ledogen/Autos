...
const GATES = [
    ...
    'carve-surface-agreement.mjs', // QUAL-07: terrain mesh carve == physics collision surface (one shared _carveCrossSection, continuous resolve) — no float above the drawn bank
