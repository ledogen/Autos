...
BODY_STATIONS = [
    (2.440, 0.730, 0.788, 0.748, 0.375, 0.906),   # front face — rounded corner
    (2.410, 0.766, 0.822, 0.782, 0.360, 0.930),
    (2.365, 0.786, 0.844, 0.804, 0.340, 0.946),
    (2.300, 0.790, 0.855, 0.820, 0.320, 0.955),
